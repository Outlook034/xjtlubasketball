...
class MonodepthOptions:
    def __init__(self):
        ...
        # VECTTA options
        self.parser.add_argument("--use_vectta",
                                 help="if set enables VECTTA (Viewpoint Equivariance Consistency Test-Time Adaptation)",
                                 action="store_true")
        self.parser.add_argument("--vectta_mode",
                                 type=str,
                                 choices=['vec', 'eata'],
                                 default='vec',
                                 help="VECTTA mode: 'vec' for VECTTA, 'eata' for EATA")
        self.parser.add_argument("--clean_pred_path",
                                 type=str,
                                 default='clean_pred_disps.npy',
                                 help="path to clean predictions file for VECTTA")
        
        # VECTTA specific parameters
        self.parser.add_argument("--vec_steps",
                                 type=int,
                                 default=5,
                                 help="number of VECTTA adaptation steps")
        self.parser.add_argument("--vec_update_mode",
                                 type=str,
                                 choices=['bn_only', 'bn_decoder', 'last_layers', 'all'],
                                 default='bn_decoder',
                                 help="VECTTA parameter update mode")
        self.parser.add_argument("--vec_lr",
                                 type=float,
                                 default=1e-4,
                                 help="VECTTA learning rate")
        self.parser.add_argument("--vec_early_stop",
                                 help="if set enables early stopping for VECTTA",
                                 action="store_true")
        self.parser.add_argument("--vec_early_stop_patience",
                                 type=int,
                                 default=3,
                                 help="VECTTA early stopping patience")
        self.parser.add_argument("--vec_grad_clip",
                                 type=float,
                                 default=1.0,
                                 help="VECTTA gradient clipping threshold")
        
        # EATA specific parameters
        self.parser.add_argument("--eata_steps",
                                 type=int,
                                 default=1,
                                 help="number of EATA adaptation steps")
        
        # Clean generation mode
        self.parser.add_argument("--generate_clean",
                                 help="if set, generates clean predictions instead of running VECTTA",
                                 action="store_true")
        
        # Mode selection
        self.parser.add_argument("--mode",
                                 type=str,
                                 choices=['generate_clean', 'adapt'],
                                 help="operation mode: 'generate_clean' to generate clean predictions, 'adapt' to run VECTTA adaptation")
