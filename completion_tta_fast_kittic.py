...
class CompletionTTAFastModule(nn.Module):
    """Fast variant of CompletionTTAModule: only updates an adaptation layer.

    The adaptation layer is inserted between encoder output and depth decoder input:
        feat_adapted = feat + adapt_layer(feat)

    Losses and augmentation pipeline mirror CompletionTTAModule in completion_tta.py.
    """
